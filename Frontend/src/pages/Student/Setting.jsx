...
const Setting = () => {
    ...
    const checkAuthAndFetchData = async () => {
      try {
        ...
        const profileRes = await axios.get(
          `https://pathfinder-maob.onrender.com/profile/${userID}`,
          {
        ...
        const jobsRes = await axios.get(
          `https://pathfinder-maob.onrender.com/jobs/appliedjobs/${userID}`,
          {
            withCredentials: true,
          },
        );
        ...
        const projectRes = await axios.get(
          `https://pathfinder-maob.onrender.com/project/${userID}`,
          {
            withCredentials: true,
          },
        );
        ...
        const experienceRes = await axios.get(
          `https://pathfinder-maob.onrender.com/experience/${userID}`,
          {
            withCredentials: true,
          },
        );
  ...
  const submitprojects = (e) => {
    ...
    axios
      .post(
        `https://pathfinder-maob.onrender.com/project/add/${userID}`,
        {
  ...
  const updateproject = (e, id) => {
    ...
    axios
      ...
      .then(() => {
        ...
        // update UI instantly
        setUserprojects((prev) =>
          prev.map((p) => (p.id === id ? { ...p, ...editProjectData } : p)),
        );
  ...
  const deleteproj = async (id) => {
    try {
      const deleteres = await axios.delete(
        `https://pathfinder-maob.onrender.com/project/delete/${userID}/${id}`,
        {
          withCredentials: true,
        },
      );
  ...
  const deleteexp = async (id) => {
    try {
      const deleteres = await axios.delete(
        `https://pathfinder-maob.onrender.com/experience/delete/${userID}/${id}`,
        {
          withCredentials: true,
        },
      );
      ...
      setuserExperience((prev) => prev.filter((exp) => exp.id !== id));
    } catch (error) {
  ...
  const updateProfile = async () => {
    try {
      ...
      formData.append(
        "college_university",
        profileData.details.college_university,
      );
    ...
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) =>
                  handleProfileChange("phone_number", e.target.value, true)
                }
                disabled={!isEditing}
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) =>
                  handleProfileChange("date_of_birth", e.target.value, true)
                }
                disabled={!isEditing}
                className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-50 disabled:cursor-not-allowed transition-all"
              />
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) =>
                  handleProfileChange("qualification", e.target.value, true)
                }
                disabled={!isEditing}
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) =>
                  handleProfileChange("graduation_year", e.target.value, true)
                }
                disabled={!isEditing}
          ...
          <div className="mt-6 space-y-2">
            ...
            <input
              ...
              onChange={(e) =>
                handleProfileChange("college_university", e.target.value, true)
              }
              disabled={!isEditing}
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="b text-sm font-semibold text-gray-700 flex items-center gap-2">
              ...
              <input
                ...
                onChange={(e) =>
                  handleProfileChange("linkedin_url", e.target.value, true)
                }
                disabled={!isEditing}
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) =>
                  handleProfileChange("github_url", e.target.value, true)
                }
                disabled={!isEditing}
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100 shadow-lg">
            ...
            {userprojects.map((project, index) => {
              ...
              return (
                ...
                >
                  ...
                  {isEditing && (
                    <form
                      onSubmit={(e) => updateproject(e, project.id)}
                      className="space-y-4"
                    >
                      <input
                        type="text"
        ...
        {addproj &&
          projects.map((project, index) => (
            <div
              key={index}
              className="bg-white rounded-2xl p-6 mb-6 border-2 border-blue-300 shadow-lg"
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleProjectChange(index, "tech_stack", e.target.value)
                      }
                      className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                    />
                  </div>
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
              {userExperience.map((experience, index) => (
                <div
                  ...
                  className="group bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-blue-200 transform hover:-translate-y-1"
                >
          ...
          {addexp &&
            experiences.map((exp, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl p-6 border-2 border-purple-200 shadow-md hover:shadow-xl transition-all duration-300"
              >
                <div className="flex justify-between items-center mb-6">
                  <div className="flex items-center gap-3">
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {Appliedjobs.map((job) => (
                <div
                  key={job.id}
                  className="border-2 border-gray-200 rounded-xl p-5 hover:shadow-lg hover:border-cyan-300 transition-all"
                >
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        {savejob.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="text-gray-600">Bookmark jobs to see them here</p>
          </div>
        ) : (
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case "appliedjob":
        return renderAppliedJobSettings();
      case "savedjob":
              ...
              <nav className="space-y-1">
                {sidebarItems.map(({ id, label, icon: Icon }) => (
                  <button
                    key={id}
                    onClick={() =>
                      id === "logout" ? Logoutsetting() : setActiveTab(id)
                    }
