...
const StudentAnalytics = () => {
  ...
  const studentUID = localStorage.getItem('userUID');
    ...
    const fetchAnalytics = async () => {
      ...
      try {
        const response = await axios.get(
          `https://pathfinder-maob.onrender.com/student/analytics/${studentUID}`,
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 mb-8">
          ...
          <StatCard
            title="Hired Status"
            value={statistics.students_hired > 0 ? "Hired" : "Not Hired"}
            icon="🎉"
            color={statistics.students_hired > 0 ? "bg-green-500" : "bg-gray-500"}
          />
        </div>
