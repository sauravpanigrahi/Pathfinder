    ...
    const fetchResume = async () => {
      try {
        ...
        const resumeRes = await axios.get(
          `https://pathfinder-maob.onrender.com/review/getresume/${userUID}`,
        );
        ...
        if (!aiResult || aiScore === null) {
          const aiRes = await axios.get(
            `https://pathfinder-maob.onrender.com/review/analyze_resume/${userUID}/${job_id}`,
          );
        ...
        <div className="bg-white rounded-lg shadow p-3 mb-4 flex justify-between items-start">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Get AI-powered insights on your resume’s strengths and
              improvements.
            </p>
          </div>
            ...
            <section className="bg-white p-6 rounded-lg shadow w-full md:w-1/2 h-[500px] overflow-y-auto">
              ...
              {!review?.analysis ? (
                <p className="text-gray-500">
                  No AI analysis available yet. Click "Re-run Analysis" to
                  start.
                </p>
              ) : (
