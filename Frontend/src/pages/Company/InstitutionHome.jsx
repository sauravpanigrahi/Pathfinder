            ...
            <div className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-lg text-gray-900">{selectedApplication.Fullname}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Email</p>
                  <p className="text-lg text-gray-900">{selectedApplication.Email}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Phone</p>
                  <p className="text-lg text-gray-900">{selectedApplication.phonenumber}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Job Role</p>
                  <p className="text-lg text-gray-900">{selectedApplication.Job_role}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Company</p>
                  <p className="text-lg text-gray-900">{selectedApplication.Job_company}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Location</p>
                  <p className="text-lg text-gray-900">{selectedApplication.Job_location}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Qualification</p>
                  <p className="text-lg text-gray-900">{selectedApplication.high_qualification}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">College</p>
                  <p className="text-lg text-gray-900">{selectedApplication.college}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">Graduation Year</p>
                  <p className="text-lg text-gray-900">{selectedApplication.graduation_year}</p>
                </div>
                {selectedApplication.prev_company && (
                  <div>
                    <p className="text-sm font-medium text-gray-500">Previous Company</p>
                    <p className="text-lg text-gray-900">{selectedApplication.prev_company}</p>
                  </div>
                )}
              </div>
              <div>
                <p className="text-sm font-medium text-gray-500 mb-2">Why interested in joining?</p>
                <p className="text-gray-900 bg-gray-50 p-4 rounded-lg">{selectedApplication.why_join}</p>
              </div>
  ...
  <li className="p-6 hover:bg-gray-50 transition-colors duration-150 ease-in-out">
    <div className="flex items-center justify-between">
      <div className="flex items-center">
        ...
        <div className="ml-4">
          <h3 className="text-xl font-semibold">{application.Fullname || "Unknown Applicant"}</h3>
          <p className="text-gray-600">{application.Job_role || "No role specified"}</p>
