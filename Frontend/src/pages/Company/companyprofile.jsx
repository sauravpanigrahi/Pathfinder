    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                setLoading(true);
                setError(null);
                const profileRes = await axios.get(`http://localhost:8000/company/${uid}`);
                console.log('Profile response:', profileRes.data);
                const jobsRes = await axios.get(`http://localhost:8000/company/${uid}/jobs`);
   ...
   const handleSaveProfile = async () => {
    try {
        ...
        const response = await axios.put(
            `http://localhost:8000/company/${uid}/edit`,
            payload
        );
