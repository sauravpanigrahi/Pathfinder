...
import { timeAgo, formatDateTime } from "../js/Time";
...
const JobCard = ({ job, Resume, isTopMatch }) => {
  ...
  const interviewDT = applicationStatus?.interview_timestamp
    ? formatDateTime(applicationStatus.interview_timestamp)
    : { date: "", time: "" };
  ...
  `}
      >
        ...
        <div className="mt-4 flex flex-wrap items-center gap-2">
          ...
          <span
            className={`inline-flex items-center rounded-full  px-3 py-1 text-xs  text-gray-700 ring-1 ring-inset ring-gray-300 font-bold ${
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          ...
          {loadingStatus ? (
            <button
              disabled
              className="inline-flex items-center justify-center rounded-lg bg-gray-300 px-2 py-2 text-sm font-medium text-gray-600 cursor-not-allowed"
            >
              Loading...
            </button>
            ...
            <button
              disabled
              className="inline-flex items-center justify-center rounded-lg bg-green-600 px-2 py-2 text-sm font-medium text-white cursor-not-allowed"
            >
              ✓ Accepted
            </button>
            ...
            <button
              disabled
              className="inline-flex items-center justify-center rounded-lg bg-yellow-500 px-2 py-2 text-sm font-medium text-white cursor-not-allowed"
            >
              ⏳ Pending
            </button>
            ...
            <>
              <button
                disabled
                className="inline-flex items-center justify-center rounded-lg bg-red-500 px-2 py-2 text-sm font-medium text-white cursor-not-allowed"
              >
                ✗ Rejected
              </button>
            </>
            ...
            <>
              ...
              <button
                ...
                className="inline-flex items-center justify-center rounded-lg bg-blue-600 px-1 py-1 text-sm font-medium text-white hover:bg-blue-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 transition-colors"
              >
                View Details
              </button>
            </>
            ...
            <button
              disabled
              className="inline-flex items-center justify-center rounded-lg bg-blue-600 px-2 py-2 text-sm font-medium text-white cursor-not-allowed"
            >
            ...
            <button
              disabled
              className="inline-flex items-center justify-center rounded-lg bg-red-600 px-2 py-2 text-sm font-medium text-white cursor-not-allowed"
            >
              ✗ Rejected
            </button>
          ) : (
      ...
      {showdetails && (
        <div className="fixed top-40 left-1/2 z-50 w-[100%] max-w-md -translate-x-1/2 rounded-xl border bg-white p-5 shadow-xl">
          ...
          <div className="text-sm text-gray-700 space-y-2">
            ...
            <p>
              <b>Platform:</b> {applicationStatus.platform}
            </p>
            <p>
              <b>Link:</b>{" "}
              <a
                href={applicationStatus.meeting_link}
